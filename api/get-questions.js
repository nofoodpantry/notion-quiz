...
// Safe options parser (no regex literals)
...
const brRe = new RegExp("<br\s*/?>", "ig");          // match 
, 
, 
...
// Only add filter if we actually have any mapped IDs
...
lectureIds: Array.isArray(p["Lecture"]?.relation) ? p["Lecture"].[relation.map](http://relation.map)(r => [r.id](http://r.id)) : [],
